...
This README is gonna double as a design doc and a HowTo at the same time. It'll have my thoughts going into the project and instructions on how to use the finished product once I get to that point. 

For my thoughts during development, refer to DevNotes.txt

I love DnD and wanted to tie in a personal interest into my portfolio projects so here we are.

The Enounter Logic: The encounter logic will be using the 2014 5th edition rules instead of the new 2024 ones because it'll be more interesting to code (also the Open5e api uses the 2014 rules so I'll have no issues down the line).
